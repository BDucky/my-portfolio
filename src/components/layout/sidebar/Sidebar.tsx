...
export default function Sidebar({ onNavClick, active }: { onNavClick: (id: string) => void; active: string }) {
  return (
    <aside className="sidebar w-full h-full flex flex-col gap-2 items-center rounded-none md:rounded-2xl py-6 px-6 bg-white/90 dark:bg-zinc-900/90 shadow-2xl border border-zinc-200 dark:border-zinc-800 backdrop-blur-md z-30">
      {/* Profile Image */}
      <img
        src={profileImage}
        alt="Profile"
